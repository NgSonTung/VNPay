  ...
  return (   
    ...
    <Text style={styles.text1}>15/07/2022</Text>
      <View style={styles.khuyenmai}>
        ...
        <Text style={styles.tieude}>Mừng khai trương LOTTE Mart Vinh - Thanh toán VNPAY - QR giảm tới 100K</Text>
        ...
        <Text style={styles.message}> 🎉 Nhân dịp khai trương đại siêu thị LOTTE Mart Vinh, Ví VNPAY-QR tặng quà khủng khi thanh toán VNPAY-QR để cả gia đình thỏa sức mua sắm: {"\n"}
        ✔ Thanh toán đơn hàng từ 400K, tặng mã LOTTECAMON: giảm 4% tối đa 50K.{"\n"}
        ✔ Thanh toán đơn hàng từ 1.200K, tặng mã CAMONLOTTE: giảm 4% tối đa 100K.{"\n"}
        ✔ Ưu đãi chỉ áp dụng khi thanh toán VNPAY-QR tại LOTTE Mart Vinh {"\n"}{"\n"}
        ⏲️ Thời gian phát hành mã: 15/07 - 21/02/2022{"\n"}{"\n"}
        📌 Lưu ý: {"\n"}
        - Mã giảm giá áp dụng cho lần thanh toán tiếp theo với đơn hàng từ 300K.{"\n"}
        - Khách hàng được sử dụng mỗi mã một lần trong thời gian diễn ra chương trình.{"\n"}
        - Thời hạn sử dụng mã trong vòng 14 ngày.
        </Text>
      </View>
      ...
      <View style={styles.khuyenmai}>
        ...
        <Image style={styles.gift} source={require("../assets/gift.png")} />
        <Text style={styles.tieude}>⚽ Sân cỏ rực lửa-Nhiệt huyết khán đài</Text>
        <Image style={styles.tick} source={require("../assets/read.png")} />
